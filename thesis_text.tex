...
Kromě této zcela základní informace se dá dále sbírat mnoho doplňkových informací, například četnost výskytu jednotlivých slov.
...
Lucene je vysoce výkonná, škálovatelná, volně širitelná vyhledávací knihovna celá napsána v jazyce Java. Již několik let je nejpopulárnější vyhledávací technologií na této platformě. Díky své popularitě se však dočkala i přepsání do dalších jazyků jako například
Perl, Python, Ruby, C/C++, PHP a C\# (.NET). 

Je nutno podotknout, že Lucene není žádný vyhledávací produkt, hotová aplikace. Lucene je pouze nástroj, se kterým se dají takové aplikace naprogramovat.

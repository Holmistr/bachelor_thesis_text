...
\begin{itemize}
	...
	\item Import testovacích dat: Pro realizaci testování byl naprogramován mechanismus pro import požadavků z existujícícho systému pro správu chyb Red Hat Bugzilla. Importovaná data jsou vybrána uživatelem na základě ID požadavku, uživatel tak může přesně zvolit, které požadavky budou do systému importovány.
